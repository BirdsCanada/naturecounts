...
So there are a fair few species! But probably not that many observations. We can download all available observations of these species, by passing the `species_id`s to the `nc_data_dl()` function.
