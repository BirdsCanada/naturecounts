...
Finally we can download all observations of these species, by passing the `species_id`s to the `nc_data_dl()` function

```{r, eval = FALSE}
mice <- nc_data_dl(species = mice_ids$species_id, verbose = TRUE)
```
