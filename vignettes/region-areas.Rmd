...
For a more detailed view of IBAs, we can also grab the shape files from Bird Studies Canada.
...
Bird Conservation Regions are also available from Bird Studies Canada.
