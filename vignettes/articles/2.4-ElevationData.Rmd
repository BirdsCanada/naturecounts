...
#> source      : spat_290041744b42_10496.tif 
#> varname     : MNT_31I10NO 
#> name        :  Band_1 
#> min value   : 102.277 
#> max value   : 542.817
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'as.data.frame': unable to find an inherited method for function 'select' for signature '"sf"'
