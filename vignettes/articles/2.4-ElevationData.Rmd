...
#> source      : spat_290063bb4771_10496.tif 
#> varname     : MNT_31I10NO 
#> name        :  Band_1 
#> min value   : 102.277 
#> max value   : 542.817
...
```
#> Error in knitr::include_graphics(here::here("figures_other/spatdata11.png")): Cannot find the file(s): "figures_other/spatdata11.png"
```
...
```
#> Error: <text>:1:55: unexpected ')'
#> 1: knitr::include_graphics("figures_other/spatdata4.PNG"))
#>                                                           ^
```
...
```
#> Error: <text>:1:55: unexpected ')'
#> 1: knitr::include_graphics("figures_other/spatdata5.PNG"))
#>                                                           ^
```
