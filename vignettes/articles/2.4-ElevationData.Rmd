...
national_parks <- st_read(here::here("misc/data/nationalparks/vw_Places_Public_lieux_public_APCA.shp")) 
#> Reading layer `vw_Places_Public_lieux_public_APCA' from data source `C:\Users\dimit\Birds Canada\naturecounts\misc\data\nationalparks\vw_Places_Public_lieux_public_APCA.shp' using driver `ESRI Shapefile'
...
#> source      : spat_84d0114d7602_34000.tif 
#> varname     : MNT_31I10NO 
#> name        :  Band_1 
#> min value   : 102.277 
#> max value   : 542.817
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata11.PNG")): Cannot find the file(s): "misc/images/spatdata11.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata1.PNG")): Cannot find the file(s): "misc/images/spatdata1.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata0.PNG")): Cannot find the file(s): "misc/images/spatdata0.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata2.PNG")): Cannot find the file(s): "misc/images/spatdata2.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata3.PNG")): Cannot find the file(s): "misc/images/spatdata3.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata4.PNG")): Cannot find the file(s): "misc/images/spatdata4.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata5.PNG")): Cannot find the file(s): "misc/images/spatdata5.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata6.PNG")): Cannot find the file(s): "misc/images/spatdata6.PNG"
```
...
```
#> Error in knitr::include_graphics(here::here("misc/images/spatdata10.PNG")): Cannot find the file(s): "misc/images/spatdata10.PNG"
```
