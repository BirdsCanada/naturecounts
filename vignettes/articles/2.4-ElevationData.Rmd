...
```
#> Reading layer `vw_Places_Public_lieux_public_APCA' from data source 
#>   `C:\Users\dimit\Birds Canada\naturecounts\misc\data\nationalparks\vw_Places_Public_lieux_public_APCA.shp' using driver `ESRI Shapefile'
#> Simple feature collection with 52 features and 9 fields
#> Geometry type: MULTIPOLYGON
#> Dimension:     XY, XYZ
#> Bounding box:  xmin: -141.0019 ymin: 41.68134 xmax: -53.68772 ymax: 83.15114
...
#> Using filters: collections (QCATLAS2PC); fields_set (BMDE2.00-min)
#> Collecting available records...
#>   collection nrecords
#> 1 QCATLAS2PC   341902
#> Total records: 341,902
#> 
#> Downloading records for each collection:
#>   QCATLAS2PC
#>     Records 1 to 5000 / 341902
#>     Records 5001 to 10000 / 341902
#>     Records 10001 to 15000 / 341902
#>     Records 15001 to 20000 / 341902
#>     Records 20001 to 25000 / 341902
#>     Records 25001 to 30000 / 341902
#>     Records 30001 to 35000 / 341902
#>     Records 35001 to 40000 / 341902
#>     Records 40001 to 45000 / 341902
#>     Records 45001 to 50000 / 341902
#>     Records 50001 to 55000 / 341902
#>     Records 55001 to 60000 / 341902
#>     Records 60001 to 65000 / 341902
#>     Records 65001 to 70000 / 341902
#>     Records 70001 to 75000 / 341902
#>     Records 75001 to 80000 / 341902
#>     Records 80001 to 85000 / 341902
#>     Records 85001 to 90000 / 341902
#>     Records 90001 to 95000 / 341902
#>     Records 95001 to 1e+05 / 341902
#>     Records 100001 to 105000 / 341902
#>     Records 105001 to 110000 / 341902
#>     Records 110001 to 115000 / 341902
#>     Records 115001 to 120000 / 341902
#>     Records 120001 to 125000 / 341902
#>     Records 125001 to 130000 / 341902
#>     Records 130001 to 135000 / 341902
#>     Records 135001 to 140000 / 341902
#>     Records 140001 to 145000 / 341902
#>     Records 145001 to 150000 / 341902
#>     Records 150001 to 155000 / 341902
#>     Records 155001 to 160000 / 341902
#>     Records 160001 to 165000 / 341902
#>     Records 165001 to 170000 / 341902
#>     Records 170001 to 175000 / 341902
#>     Records 175001 to 180000 / 341902
#>     Records 180001 to 185000 / 341902
#>     Records 185001 to 190000 / 341902
#>     Records 190001 to 195000 / 341902
#>     Records 195001 to 2e+05 / 341902
#>     Records 200001 to 205000 / 341902
#>     Records 205001 to 210000 / 341902
#>     Records 210001 to 215000 / 341902
#>     Records 215001 to 220000 / 341902
#>     Records 220001 to 225000 / 341902
#>     Records 225001 to 230000 / 341902
#>     Records 230001 to 235000 / 341902
#>     Records 235001 to 240000 / 341902
#>     Records 240001 to 245000 / 341902
#>     Records 245001 to 250000 / 341902
#>     Records 250001 to 255000 / 341902
#>     Records 255001 to 260000 / 341902
#>     Records 260001 to 265000 / 341902
#>     Records 265001 to 270000 / 341902
#>     Records 270001 to 275000 / 341902
#>     Records 275001 to 280000 / 341902
#>     Records 280001 to 285000 / 341902
#>     Records 285001 to 290000 / 341902
#>     Records 290001 to 295000 / 341902
#>     Records 295001 to 3e+05 / 341902
#>     Records 300001 to 305000 / 341902
#>     Records 305001 to 310000 / 341902
#>     Records 310001 to 315000 / 341902
#>     Records 315001 to 320000 / 341902
#>     Records 320001 to 325000 / 341902
#>     Records 325001 to 330000 / 341902
#>     Records 330001 to 335000 / 341902
#>     Records 335001 to 340000 / 341902
#>     Records 340001 to 341902 / 341902
```
...
#> source      : spat_2b2028ed5d52_11040.tif 
#> varname     : MNT_31I10NO 
#> name        :  Band_1 
#> min value   : 102.277 
#> max value   : 542.817
...
```
#> Error in knitr::include_graphics("images/spatdata11.PNG"): Cannot find the file(s): "images/spatdata11.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata1.PNG"): Cannot find the file(s): "images/spatdata1.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata0.PNG"): Cannot find the file(s): "images/spatdata0.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata2.PNG"): Cannot find the file(s): "images/spatdata2.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata3.PNG"): Cannot find the file(s): "images/spatdata3.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata4.PNG"): Cannot find the file(s): "images/spatdata4.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata5.PNG"): Cannot find the file(s): "images/spatdata5.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata6.PNG"): Cannot find the file(s): "images/spatdata6.PNG"
```
...
```
#> Error in knitr::include_graphics("images/spatdata10.PNG"): Cannot find the file(s): "images/spatdata10.PNG"
```
