...
download.file(url = "https://www.albertaparks.ca/media/2941843/parks_and_protected_areas_alberta.zip",
              destfile = here("vignettes/articles/article_files/alberta_parks.zip"))
unzip(here("vignettes/articles/article_files/alberta_parks.zip"), 
      exdir = here("vignettes/articles/article_files/"))
```
...
```{r echo = FALSE}
parks <- st_read(here("vignettes/articles/article_files/Parks_Protected_Areas_Alberta.shp"))
```
...
- [Using spatial data to filter observations](region_spatial.html)
- [Exploring regional filters](region_areas.html)
