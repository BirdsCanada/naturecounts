...
ontario_kba <- sf::st_read("C:/Users/dimit/Birds Canada/naturecounts/spatial_data/KBA/ProvOntario_KBA/ontario_kba.shp")
```
```{r, eval = FALSE}
...
```{r, echo = FALSE}
kba_attributes <- read.csv("C:/Users/dimit/Birds Canada/naturecounts/spatial_data/KBA/ProvOntario_KBA/ontario_kba.csv")
```
...
```{r, echo = FALSE}
gdb_path <- "C:/Users/dimit/Birds Canada/naturecounts/spatial_data/Priority Places/PriorityPlaces.gdb"
```
