...
``` r
cedar_waxwing <- nc_data_dl(collections = "MBBA2PC", species = 16330, username = "testuser", info = "spatial_data_tutorial", timeout = 300)
```
...
![**cedarwaxwingmap**](figures/spatdatatutorial_cedarwaxwingmap-1.png)
...
```
#> Reading layer `ontario_kba' from data source 
#>   `C:\Users\dimit\Birds Canada\NatureCounts_SpatialData_Tutorial\Data\KBA\ProvOntario_KBA\ontario_kba.shp' 
...
#>   `C:\Users\dimit\Birds Canada\NatureCounts_SpatialData_Tutorial\Data\Priority Places\PriorityPlaces.gdb' 
#>   using driver `OpenFileGDB'
#> Warning in CPL_read_ogr(dsn, layer, query,
#> as.character(options), quiet, : GDAL Message 1:
#> organizePolygons() received a polygon with more than 100
#> parts.  The processing may be really slow.  You can skip the
#> processing by setting METHOD=SKIP.
