...
#> Reading layer `PriorityPlacesBoundary' from data source `C:\Users\dimit\Birds Canada\naturecounts\misc\data\priority_places\priorityplaces.gdb' using driver `OpenFileGDB'
