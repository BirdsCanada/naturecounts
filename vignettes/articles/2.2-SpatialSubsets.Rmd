...
To identify Wood Ducks observed across Ontario KBAs, we can apply the `st_intersection()` function.
...
**Congratulations**! You completed **Chapter 2 - Spatial Subsetting: KBAs and Priority Places**. Here, you spatially filtered and visualized NatureCounts data. In [Chapter 3](2.3-ClimateData.html), you can explore more spatial data visualization while linking climate data to NatureCounts observations.
