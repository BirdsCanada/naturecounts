...
```
#> Error: Cannot open "C:/Users/dimit/Birds Canada/naturecounts/misc/Data/provontario_kba/ontario_kba.shp"; The file doesn't seem to exist.
...
#> Error in eval(expr, envir, enclos): object 'ontario_kba' not found
```
...
kba_attributes <- kba_attributes %>%
  select("SiteCode",
         ...
         "Province",
         "Species")
#> Error in select(., "SiteCode", "DateAssessed", "PercentProtected", "BoundaryGeneralized", : unused arguments ("SiteCode", "DateAssessed", "PercentProtected", "BoundaryGeneralized", "Level", "CriteriaMet", "ConservationActions", "Landcover", "Province", "Species")
```
...
#> Cannot open data source C:/Users/dimit/Birds Canada/naturecounts/misc/Data/priority_places/priorityplaces.gdb
...
#> Error: Cannot open "C:/Users/dimit/Birds Canada/naturecounts/misc/Data/priority_places/priorityplaces.gdb"; The file doesn't seem to exist.
```
