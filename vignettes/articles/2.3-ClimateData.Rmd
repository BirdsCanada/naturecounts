...
#>        <int> <chr>                                <chr>                              <chr>                               <chr>      
#> 1       4030 Grus americana                       Whooping Crane                     Grue blanche                        BIRDS      
#> 2      43080 Antigone canadensis x Grus americana Sandhill x Whooping Crane (hybrid) Hybride Grue du Canada x G. blanche BIRDS
```
...
#>  4 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/… day       1978  1979 FALSE   FALSE             FALSE            
#>  5 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/… hour        NA    NA FALSE   FALSE             FALSE            
#>  6 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/… month     1978  1979 FALSE   FALSE             FALSE            
#>  7 AB    FLEET                     1797 301B6L0        NA <NA>   52.2 -112.  838. Etc/… day       1987  1990 FALSE   FALSE             FALSE            
#>  8 AB    FLEET                     1797 301B6L0        NA <NA>   52.2 -112.  838. Etc/… hour        NA    NA FALSE   FALSE             FALSE            
#>  9 AB    FLEET                     1797 301B6L0        NA <NA>   52.2 -112.  838. Etc/… month     1987  1990 FALSE   FALSE             FALSE            
#> 10 AB    GOLDEN VALLEY             1798 301B8LR        NA <NA>   53.2 -110.  640  Etc/… day       1987  1998 FALSE   FALSE             FALSE            
#> # ℹ 26,372 more rows
```
...
#> Error in eval(expr, envir, enclos): object 'bioclim_values' not found
```
...
#> Error in eval(expr, envir, enclos): object 'bioclim_data' not found
summary(bioclim_data)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': object 'bioclim_data' not found
```
