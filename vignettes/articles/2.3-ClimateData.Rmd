...
## 1 AB    DAYSLAND                  1795 301AR54        NA <NA>   52.9 -112.  689. Etc/GM… day       1908  1922 FALSE   FALSE            
## 2 AB    DAYSLAND                  1795 301AR54        NA <NA>   52.9 -112.  689. Etc/GM… hour        NA    NA FALSE   FALSE            
## 3 AB    DAYSLAND                  1795 301AR54        NA <NA>   52.9 -112.  689. Etc/GM… month     1908  1922 FALSE   FALSE            
## 4 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/GM… day       1978  1979 FALSE   FALSE            
## 5 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/GM… hour        NA    NA FALSE   FALSE            
## 6 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/GM… month     1978  1979 FALSE   FALSE            
...
![plot of chunk annual_temp](figure/annual_temp-1.png)
![plot of chunk annual_temp](figure/annual_temp-1.png)
...
![plot of chunk annual_precip](figure/annual_precip-1.png)
![plot of chunk annual_precip](figures/spatdatatutorial_annual_precip-1.png)
...
```
## [1] "C:/Users/dimit/Birds Canada/naturecounts/articles"
```
...
![plot of chunk raster_bio1](figure/raster_bio1-1.png)
...
```
![plot of chunk raster_bio1](figure/raster_bio1.png)
...
![plot of chunk scatter_bio1](figure/scatter_bio1-1.png)
![plot of chunk scatter_bio1](figure/scatter_bio1-1.png)
