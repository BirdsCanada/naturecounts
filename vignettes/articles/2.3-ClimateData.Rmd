...
#>  1 AB    DAYSLAND                  1795 301AR54        NA <NA>   52.9 -112.  689. Etc/GMT+7 day       1908  1922 FALSE   FALSE            
#>  2 AB    DAYSLAND                  1795 301AR54        NA <NA>   52.9 -112.  689. Etc/GMT+7 hour        NA    NA FALSE   FALSE            
#>  3 AB    DAYSLAND                  1795 301AR54        NA <NA>   52.9 -112.  689. Etc/GMT+7 month     1908  1922 FALSE   FALSE            
#>  4 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/GMT+7 day       1978  1979 FALSE   FALSE            
#>  5 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/GMT+7 hour        NA    NA FALSE   FALSE            
#>  6 AB    EDMONTON CORONATION       1796 301BK03        NA <NA>   53.6 -114.  671. Etc/GMT+7 month     1978  1979 FALSE   FALSE            
#>  7 AB    FLEET                     1797 301B6L0        NA <NA>   52.2 -112.  838. Etc/GMT+7 day       1987  1990 FALSE   FALSE            
#>  8 AB    FLEET                     1797 301B6L0        NA <NA>   52.2 -112.  838. Etc/GMT+7 hour        NA    NA FALSE   FALSE            
#>  9 AB    FLEET                     1797 301B6L0        NA <NA>   52.2 -112.  838. Etc/GMT+7 month     1987  1990 FALSE   FALSE            
#> 10 AB    GOLDEN VALLEY             1798 301B8LR        NA <NA>   53.2 -110.  640  Etc/GMT+7 day       1987  1998 FALSE   FALSE            
#> # ℹ 26,372 more rows
...
#> Error in UseMethod("extract"): no applicable method for 'extract' applied to an object of class "SpatRaster"
```
...
#>    SiteCode          survey_year    total_count            ID            bio1              bio2            bio3              bio4      
#>  Length:67          Min.   :1987   Min.   :  0.000   Min.   : 1.0   Min.   :-2.7267   Min.   :14.11   Min.   :-21.910   Min.   :346.0  
#>  Class :character   1st Qu.:2000   1st Qu.:  1.000   1st Qu.:17.5   1st Qu.:-2.4017   1st Qu.:14.73   1st Qu.:-21.183   1st Qu.:352.0  
#>  Mode  :character   Median :2002   Median :  1.000   Median :34.0   Median :-2.3429   Median :14.80   Median :-20.766   Median :354.0  
#>                     Mean   :2000   Mean   :  4.134   Mean   :34.0   Mean   :-0.6792   Mean   :14.99   Mean   :-17.939   Mean   :390.0  
#>                     3rd Qu.:2003   3rd Qu.:  2.000   3rd Qu.:50.5   3rd Qu.: 1.3970   3rd Qu.:15.31   3rd Qu.:-14.532   3rd Qu.:425.5  
#>                     Max.   :2005   Max.   :160.000   Max.   :67.0   Max.   : 4.0880   Max.   :15.83   Max.   : -7.527   Max.   :543.0  
#>       bio5            bio6            bio7            bio8            bio9           bio10           bio11           bio12      
#>  Min.   : 52.0   Min.   :10.00   Min.   :42.27   Min.   :135.0   Min.   :34.00   Min.   :134.0   Min.   :34.00   Min.   :10.98  
#>  1st Qu.: 56.0   1st Qu.:14.00   1st Qu.:46.05   1st Qu.:145.0   1st Qu.:44.00   1st Qu.:145.0   1st Qu.:51.50   1st Qu.:11.82  
#>  Median : 56.0   Median :14.00   Median :46.59   Median :147.0   Median :44.00   Median :147.0   Median :53.00   Median :12.06  
#>  Mean   : 67.9   Mean   :13.88   Mean   :54.81   Mean   :178.3   Mean   :46.51   Mean   :178.3   Mean   :52.15   Mean   :11.99  
#>  3rd Qu.: 80.5   3rd Qu.:14.00   3rd Qu.:65.93   3rd Qu.:215.0   3rd Qu.:49.50   3rd Qu.:215.0   3rd Qu.:53.00   3rd Qu.:12.07  
#>  Max.   :104.0   Max.   :17.00   Max.   :74.12   Max.   :270.0   Max.   :56.00   Max.   :270.0   Max.   :61.00   Max.   :13.89  
#>      bio13           bio14            bio15           bio16            bio17           bio18           bio19          longitude     
#>  Min.   :21.53   Min.   : 940.5   Min.   :21.38   Min.   :-29.17   Min.   :39.16   Min.   :12.90   Min.   :-13.17   Min.   :-117.1  
#>  1st Qu.:23.42   1st Qu.:1214.9   1st Qu.:22.73   1st Qu.:-28.41   1st Qu.:44.32   1st Qu.:14.73   1st Qu.:-11.26   1st Qu.:-113.3  
#>  Median :23.86   Median :1443.2   Median :22.96   Median :-27.86   Median :50.79   Median :14.80   Median :-10.89   Median :-113.0  
#>  Mean   :25.17   Mean   :1342.1   Mean   :22.83   Mean   :-25.21   Mean   :48.04   Mean   :14.96   Mean   :-10.78   Mean   :-112.7  
#>  3rd Qu.:26.12   3rd Qu.:1465.4   3rd Qu.:23.06   3rd Qu.:-21.73   3rd Qu.:51.47   3rd Qu.:15.31   3rd Qu.:-10.72   3rd Qu.:-111.7  
#>  Max.   :33.67   Max.   :1499.5   Max.   :24.50   Max.   :-15.46   Max.   :51.83   Max.   :15.83   Max.   : -3.01   Max.   :-110.2  
#>     latitude              geometry 
#>  Min.   :51.05   POINT        :67  
#>  1st Qu.:54.24   epsg:4326    : 0  
#>  Median :59.90   +proj=long...: 0  
#>  Mean   :57.49                     
#>  3rd Qu.:59.97                     
#>  Max.   :60.21
```
