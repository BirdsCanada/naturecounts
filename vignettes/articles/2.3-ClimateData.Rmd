...
#> Error in eval(expr, envir, enclos): object 'worldclim_stack' not found
```
...
#> Error: object 'worldclim_stack' not found
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'plot': object 'worldclim_stack' not found

# Summary statistics for each layer
summary(worldclim_stack)
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'summary': object 'worldclim_stack' not found
```
...
#> Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'extract': object 'worldclim_stack' not found
```
