...
```
#> Error: Cannot open "C:/Users/dimit/Birds Canada/naturecounts/data/boundary/mauricie_boundary.shp"; The file doesn't seem to exist.
```
...
#> 1: mauricie_birds_df <- read.csv(here::here("misc/data/mauricie_birds_df.csv")
#>    ^
```
...
#> ℹ In argument: `survey_year = buffer_i$survey_year`.
#> Caused by warning:
#> ! Unknown or uninitialised column: `survey_year`.
