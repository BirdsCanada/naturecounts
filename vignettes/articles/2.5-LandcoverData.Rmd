...
landcover <- rast(here::here("misc/data/landcover-2015-classification.tif"))
...
``` r
mauricie_birds_df <- read.csv(here::here("misc/data/mauricie_birds_df.csv")
...
#> Error in select(., point_id, ed, np): unused arguments (point_id, ed, np)
```
