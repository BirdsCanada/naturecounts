#' Download Data from the Spatialized Canadian National Forest Inventory (SCANFI)
#'
...
#' All variable are available in snapshots every 5 years between 1985 and 2025 at
...
scanfi_download <- function(
  ...
  if(use_date == TRUE) {
    available_years <- seq(from = 1985,
                           to = 2025,
                           by = 5)
    
    closest_year <- data.frame(data_year = sort(unique(data$survey_year)))
    
    outside_years <- c(closest_year$data_year[closest_year$data_year < 1980], 
                       closest_year$data_year[closest_year$data_year > 2030])
    
    if(length(outside_years) > 0) {
      warning("[SCANFI Download] Data contains years more than 5 years away",
    ...
    closest_year <- dplyr::filter(closest_year, !(.data$data_year %in% outside_years))
    
    for(i in closest_year$data_year) {
      
      closest_year$scanfi_year[closest_year$data_year == i] <- available_years[which(abs(i-available_years) == min(abs(i-available_years)))]
    ...
    necessary_years <- ifelse(is.null(snapshot_year), 2025, snapshot_year)
  ...
  for(i in necessary_years) {
    filename[[i]] <- data.frame(variable = scanfi_vars) %>%
      dplyr::mutate(
        filename = dplyr::case_when(
          variable ==
            "age" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_age_median_", i, "_v2_20260119.tif"),
          variable ==
            "biomass" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_att_biomass_", i, "_v2_20260119.tif"),
          variable ==
            "closure" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_att_closure_", i, "_v2_20260119.tif"),
          variable ==
            "height" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_att_height_", i, "_v2_20260119.tif"),
          variable ==
            "nfilc" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_att_nfiLandcover_", i, "_v2_20260119.tif"),
          variable ==
            "balsamfir" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_balsamFir_", i, "_v2_20260119.tif"),
          variable ==
            "blackspruce" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_blackSpruce_", i, "_v2_20260119.tif"),
          variable ==
            "douglasfir" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_douglasFir_", i, "_v2_20260119.tif"),
          variable ==
            "jackpine" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_jackPine_", i, "_v2_20260119.tif"),
          variable ==
            "lodgepolepine" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_lodgepolePine_", i, "_v2_20260119.tif"),
          variable ==
            "ponderosapine" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_ponderosaPine_", i, "_v2_20260119.tif"),
          variable ==
            "tamarack" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_tamarack_", i, "_v2_20260119.tif"),
          variable ==
            "whiteredpine" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_whiteRedPine_", i, "_v2_20260119.tif"),
          variable ==
            "broadleaf" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_broadleaf_", i,"_v2_20260119.tif"),
          variable ==
            "otherconifer" ~ paste0("https://ftp.maps.canada.ca/pub/nrcan_rncan/Forests_Foret/SCANFI/v2/SCANFI_spsCC_otherConiferous_", i, "_v2_20260119.tif")
        )
      )
  }
