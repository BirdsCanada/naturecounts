...
#> Warning: [MODIS Landcover Download] MODIS landcover data unavailable for all years before 2001 as well as . landcover_extract() will extract landcover data from 2001 or the nearest year for these observations.
