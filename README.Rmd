...
Fetch all observations of moose which are **publicly** available to a local data frame.
```{r}
...
- Collections
- [Species Codes](https://birdstudiescanada.github.io/naturecounts/docs/articles/species-codes.html)
